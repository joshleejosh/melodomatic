...
class ScaleTest(unittest.TestCase):
    ...
    def test_eq(self):
        ...
        _,s = self.bindit(':SCALE TheScale .seed SEEDY .root 59 .intervals 0 1 3 5 6 8 10 .move_time 12')
        _,t = self.bindit(':s TheScale .se SEEDY .r 59 .i 0 1 3 5 6 8 10 .mt 12')
        self.assertEqual(s, t)
        # ID is case sensitive
        _,u = self.bindit(':s THESCALE .se SEEDY .p 59 60 62 64 65 67 69 .mt 12')
